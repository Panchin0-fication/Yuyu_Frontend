...
export default function InfoWebPage() {
  ...
  const SECTION =
    "w-80 group h-96 rounded-lg bg-white p-2.5 [box-shadow:6px_6px_5px_#69abd2] transition-shadow duration-500 hover:[box-shadow:6px_6px_5px_#980e53]";
  const SECTION_H1 =
  ...
  return (
    <>
      ...
      <div className={"flex gap-20 flex-wrap justify-center mt-5 mb-5"}>
        <div
