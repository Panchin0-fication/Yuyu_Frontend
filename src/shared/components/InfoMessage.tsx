...
export default function InfoMessage({
  ...
  const INFO_MESSAGE =
    "z-10 justify-self-center fixed left-0 right-0 top-0 bottom-0 bg-white border-[3px] border-gray-100 rounded-2xl py-2.5 px-11.25 w-125 h-max flex gap-2.5 flex-col";
  const INFO_VARIOUS =
  ...
  const INFO_BUTTON =
    "[&_button]:bg-white [&_button]:p-1.25 [&_button]:border-2 [&_button]:border-black [&_button]:text-lg [&_button]:w-max [&_button]:hover:bg-blue-600 [&_button]:hover:text-white [&_button]:hover:border-white";
  return (
    <>
